...
#define CHECK_EQ(x, y) CHECK_((x) == (y), x,y)
#define CHECK_NE(x, y) CHECK_((x) != (y), x,y)
#define CHECK_LE(x, y) CHECK_((x) <= (y), x,y)
#define CHECK_LT(x, y) CHECK_((x) < (y) ,x,y)
#define CHECK_GE(x, y) CHECK_((x) >= (y),x,y )
#define CHECK_GT(x, y) CHECK_((x) > (y) ,x,y)
#endif
